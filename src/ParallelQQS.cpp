...
INLINE_VAR constexpr const static char* Help1 = "-h                             获取帮助\n"
"-i (--mid)                     指定打开的Midi文件\n"
...
"-fps (--fps)                   视频的 FPS.\n"
"示例用法: ";
INLINE_VAR constexpr const static char* Help2 =" -i \"A.mid\" -o \"A.mp4\"\n";
#else
...
INLINE_VAR constexpr const static char* Help1 =
"-h                             Get help page.\n"
...
void Run(const RenderOptions& opt)
{
	...
	RenderFile file;
	NVnoteList MIDI;
	MIDI=file.Open(fileName);
	MultithreadRenderer renderer(opt,MIDI);
